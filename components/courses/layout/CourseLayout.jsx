  ...
  return (
    ...
    `}
        ...
        <div
          ...
          border-blue-500 w-1/4 py-2 px-6 hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out`}
        >
        ...
        <div
          ...
          w-1/4 py-2 px-6 hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out`}
        >
