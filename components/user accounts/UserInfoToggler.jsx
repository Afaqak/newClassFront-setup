...
const UserInfoToggler = ({
  ...
  return (
    <div
      className={`bg-cyan-100 dark:bg-gray-800
  ...
  `}
    >
      ...
      <div className="mb-2 text-center py-2">
        {<p className="text-cyan-600 font-bold">Id : {user._id}</p>}
      </div>
      <div className="flex items-center justify-center -ml-4">
        <div className="flex items-center">
          <label className="flex items-center">
            ...
            <span
              className={`font-bold ${
                user.valid ? "text-cyan-600" : "text-gray-500" }`}
            >
          ...
          <label className="flex items-center">
            ...
            <span
              className={` text-gray-800 ${
                user.teacher ? "text-cyan-600" : "text-gray-500"
              }`}
            >
